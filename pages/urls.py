...
from .views import HomePageView, AboutPageView, ContactPageView, ProductCreateView, ProductIndexView, ProductShowView, ProductSuccessView, CartView, CartRemoveAllView, ImageViewFactory, ImageViewNoDI
